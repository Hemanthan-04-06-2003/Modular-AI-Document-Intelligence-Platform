...
2. Conversation memory and saved sessions
3. PDF highlights with page-level citations
4. Multi-file comparison and synthesis
5. Analytics dashboard for chunking, latency, and model health
